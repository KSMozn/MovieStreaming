...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildTitleMetadata(params.tmdbId, "tv", { country });
}

export default function TvCountryPage({ params }: Props) {
  const country = countryBySlug(params.country);
  if (!country) notFound();
  return <TitlePageBody rawId={params.tmdbId} mediaType="tv" country={country} />;
}
