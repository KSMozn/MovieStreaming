...
const SHORT_DESCRIPTION =
  "ReelSeek is a streaming-discovery service for the Middle East. Viewers search any movie or TV show and instantly see which streaming services carry it in Egypt, Saudi Arabia, or the UAE — with ratings, cast, and subscription, rental, or purchase labels. ReelSeek does not stream content itself; it links to the providers that do.";

const BOILERPLATE =
  "ReelSeek is a movie and TV streaming-discovery service built for the Middle East, where viewing choices are split across global platforms like Netflix, Prime Video, Disney+ and Apple TV+ and regional services like Shahid, OSN+, TOD and Watch It. Because streaming rights are licensed per country, the same title can live on different services — or none — in Egypt, Saudi Arabia and the UAE; ReelSeek computes availability separately for each market and labels every result as subscription, rental or purchase, with a direct link to the provider. The service combines licensed catalogue data from TMDb and Watchmode with IMDb ratings via OMDb, requires no account, carries no ads or analytics SDKs, and is available on the web with native iOS and Android apps in pre-release. ReelSeek hosts no video content and is not affiliated with any streaming provider.";
